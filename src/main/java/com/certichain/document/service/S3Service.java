...
public class S3Service {
    ...
    public void uploadFile(String key, InputStream data, String contentType) throws IOException {
        PutObjectRequest req = PutObjectRequest.builder()
                .bucket(bucket)
                .key(key)
                .contentType(contentType)
                .build();
        s3.putObject(req, RequestBody.fromInputStream(data, data.available()));
    }
